...
from tensorflow.keras.layers import  Bidirectional, Input, Embedding, LSTM, Dense, Dropout
...
def build_model(train_data, valid_data):
    ...
    encoder_lstm1 = Bidirectional(LSTM(128, dropout=0.4, return_sequences=True))(text_embedding)
    encoder_lstm2 = Bidirectional(LSTM(64, dropout=0.4))(encoder_lstm1)
